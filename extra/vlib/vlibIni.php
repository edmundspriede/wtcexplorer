...
// +----------------------------------------------------------------------+
//
// $Id: vlibIni.php,v 1.1.1.1 2006/08/29 10:00:07 martin Exp $
    ...
    class vlibIni {
        ...
        function vlibTemplate () {
            ...
            return array(
                        ...
                        'TEMPLATE_DIR' => CMS_BASETPLPATH,   // Default directory for your template files (full path)
                        ...
                        'CACHE_DIRECTORY' => CMS_LIBPATH.'vlib/vlibTemplateCache/',
