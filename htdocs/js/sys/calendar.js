...
//ush: saliku kopaa calendar.setup ar showCalendar
//fjai jaapadod tikai lauka id un taa zem lauka paraadiss date-pikeri un peec tam updeitos lauku ar veertiibu
function showCalendar(id,format)
{

var params={inputField:id};
...
Calendar._TT["TIME_PART"] = "Click to change value";
...
if (el.navtype != 300 || el.navtype != 100) 
{
